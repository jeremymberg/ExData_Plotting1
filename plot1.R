...
Make_plot1 <- function(HP_file = "household_power_consumption.txt") {
##  This plots a histogram of Global Active Power
##
...
##        
        ...
        hist(HP_df$Global_active_power, xlim = c(0, 7), ylim = c(0, 1200), 
             xlab = "Global Active Power (kilowatts)", xaxt = "n", yaxt = "n",
             col = "red", cex.lab = 0.75,
             main = "Global Active Power")
        axis(side = 1, at = c(0, 2, 4, 6), cex.axis = 0.7)
        axis(side = 2, at = c(0, 200, 400, 600, 800, 1000, 1200), cex.axis = 0.7)
}
